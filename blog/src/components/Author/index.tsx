  ...
  <div className={styles.author}>
    ...
    <div className={styles.author__desc}>
      <Link to={`/blog/author/${id}`}>
        <p className={isItSignature ? clsx(styles.author__name, styles.author__name__signature) : styles.author__name}>
          {name}
        </p>
      </Link>
      <p
        className={
          isItSignature ? clsx(styles.author__company, styles.author__company__signature) : styles.author__company
        }
      >{`@${about}`}</p>
    </div>
  </div>
